...
public class AccountRepository {
    ...
    public void blockAccount(final String pix){
        var account = findByPix(pix);
        account.block();
    }

    public void unblockAccount(final String pix){
        var account = findByPix(pix);
        account.unblock();
    }
    ...
    public void traferMoney(final String sourcePix,final String targetPix,final  long amount){
